						...
						<table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
							...
							<tbody>
								<tr v-for="region in regions" :key="region.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
									...
									<td class="px-6 py-4">
										<a @click="editRegion(region)"	class="font-medium text-blue-600 dark:text-blue-500 hover:underline">አስተካክል</a>
										|
										<a @click="confirmDelete(region)" class="font-medium text-red-600 dark:text-red-500 hover:underline">አጥፋ</a>
									</td>
								</tr>
