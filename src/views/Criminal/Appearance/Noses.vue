<template>
	<AdminLayout>
			...
			<div class="lg:col-span-7 xl:col-span-8">
				...
				<div class="max-w-full overflow-x-auto custom-scrollbar">
						...
						<table class="app-table">
							...
							<tbody>
								<tr v-for="nose in noses" :key="nose.key" class="app-table-row">
									<th scope="row"
									...
									<td class="px-6 py-4">
										<div class="flex justify-end gap-3">
											<button type="button" @click="editNose(nose)" class="app-link-edit">{{ $t('common.edit') }}</button>
											<button type="button" @click="confirmDelete(nose)" class="app-link-delete">{{ $t('common.delete') }}</button>
										</div>
									</td>
								</tr>
		...
		<ConfirmDialog v-model="isModalOpen" :item-name="nose.name" @confirm="deleteNose()" />
	</AdminLayout>
</template>
