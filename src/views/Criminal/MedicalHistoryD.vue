<template>
  <AdminLayoutMedical>
      ...
      <div class="w-1/2 mr-10">
        ...
        <div class="relative z-20 bg-transparent">
          <select v-model="medical.disease_type_id"
            ...
            <option v-for="diseaseType in diseaseTypes" :key="diseaseType.id" :value="diseaseType.id">{{
    ...
    <div class="">
      <div class=" mt-6">
        <Button class="w-1/7" :size="size" :variant="variant" :startIcon="startIcon" :endIcon="endIcon"
  ...
  setup() {
    ...
    const fetchDiseasetype = async () => {
      try {
        ...
        console.error('የበሽታ አይነት መረጃ ማምጣት ላይ ስህተት!', error);
      }
    };
    const submitData = async () => {
      ...
      Object.entries(medical.value).forEach(([key, value]) => {
