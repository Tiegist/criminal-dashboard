...
>
  ...
  <div class="p-4 border-t border-gray-100 dark:border-gray-800 sm:p-6">
    ...
    <span class="font-bold mr-11 text-gray-800">የወንጀል አይነት  :</span>{{ matchedHistory.crime?.name }}
      </p>
      <p  class="mt-5 text-sm text-blue-800 dark:text-white/90">
     <span class="font-bold mr-16 text-gray-800"> የወንጀሉ ገለጻ :</span> {{ matchedHistory.crime_description}}
    </p>
  </div>
  <div class="mt-5">
   ...
   <Button size="sm" variant="outline" @click="redirectToPrisionerCourtHistory">የታራሚዉን የፍርድቤት ታሪክ ይመልከቱ </Button>
    </div>
  </div>
...
//PrisionerInfo,
fetchSinglePrisionerCrimes,
redirectToPrisionerCourtHistory,
