      ...
      <div :class="[
        ...
        <div class="p-4 border-t border-gray-100 dark:border-gray-800 sm:p-6">
          <div class="space-y-5 px-20">
            ...
            <Button size="sm" variant="outline" @click="redirectToPrisionerCourtHistory">የታራሚዉን የፍርድቤት ታሪክ ይመልከቱ
            </Button>
          </div>
        </div>
...
export default {
  ...
  setup() {
    ...
    const fetchSinglePrisionerCrimes = (id) => {
      ...
      axios.get(`https://kalkidan.net:2083/api/Prisioner_crime`).then((res) => {
