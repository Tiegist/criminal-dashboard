<template>
		...
		<div class="w-1/2">
			...
			<div class="relative z-20 bg-transparent">
				<select v-model="prisonerPersonalInfo.educational_level_id"
					...
					:class="{ 'text-gray-800 dark:text-white/90': true }">
					<option value="" disabled selected></option>
					<option v-for="education in educationalLevels" :key="education.id" :value="education.id">{{
	...
	<div class="flex w-full mt-5">
		...
		<div class="w-1/2 ">
			...
			<input type="text" v-model="prisonerPersonalInfo.closest_respondent"
	...
	<div class="flex w-full mt-5">
		...
		<div class="w-1/2">
			...
			<input type="text" v-model="prisonerPersonalInfo.closest_respondent_district"
				class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
		</div>
	</div>
	...
	<div class="flex w-full mt-5">
		<div class="w-1/2 mr-10">
			...
			<div class="relative">
				<flat-pickr v-model="prisonerPersonalInfo.date_time_entered" :config="flatpickrConfig"
	...
	<div class="flex w-full mt-5">
		<div class="w-1/2 mr-10">
			...
			<input type="text" v-model="prisonerPersonalInfo.job"
				class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
		</div>
		<div class="w-1/2 ">
			<label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
			...
			<input type="text" v-model="prisonerPersonalInfo.current_district"
				class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
		</div>
		<!-- ///////// -->
	</div>
	<div class="flex w-full mt-5">
		...
		<div class="w-1/2 mr-10">
			...
			<div class="relative">
				<input v-model="prisonerPersonalInfo.phone_number" placeholder="ሞባይል ስልክ (e.g., 555-000-0000)"
					type="tel"
