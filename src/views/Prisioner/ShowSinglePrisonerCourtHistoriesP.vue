          ...
          <div class="space-y-5 px-20">
            ...
            <div class="">
              ...
              <p class="mt-5 text-sm text-blue-800 dark:text-white/90">
                <span class="font-bold mr-16 text-gray-800"> የተሻሻለዉ የፍርድ ቤት ስም :</span> {{
                  matchedHistory.updatedCourt?.name}}
              </p>
            </div>
            <div class="mt-5">
              <p class="mt-5 text-sm text-blue-800 dark:text-white/90">
...
export default {
  ...
  setup() {
    ...
    const fetchSinglePrisionerCourtHistories = (id) => {
      ...
      axios.get(`https://kalkidan.net:2083/api/prisonerCourt`).then((res) => {
