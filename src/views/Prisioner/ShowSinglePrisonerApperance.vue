...
>
  ...
  <div class="mt-5">
   ...
   <span class="font-bold mr-23 text-gray-800">አይን:</span>{{ matchedHistory.eye?.name }}
     ...
     <p  class="mt-5 text-sm text-blue-800 dark:text-white/90">
      <span class="font-bold mr-23 text-gray-800">ጥርስ:</span> {{ matchedHistory.teeth?.name }}
     </p>
    </div>
    <div class="">
     <p  class="mt-5 text-sm text-blue-800 dark:text-white/90">
      <span class="font-bold mr-22 text-gray-800">ክንፈር:</span> {{ matchedHistory.lip?.name }}
     </p>

     <p  class="mt-5 text-sm text-blue-800 dark:text-white/90">
 <span class="font-bold mr-26 text-gray-800">ጆሮ:</span>  {{ matchedHistory.ear?.name }}
     </p>
    </div>
    <div class="">
     <p  class="mt-1 text-sm text-blue-800 dark:text-white/90">
    <span class="font-bold mr-25 text-gray-800">ቁመት</span>{{ matchedHistory.height }}
     </p>
     <p  class="mt-5 text-sm text-blue-800 dark:text-white/90">
    <span class="font-bold mr-18 text-gray-800"> የፊት ግጽታ :</span>  {{ matchedHistory.face }}
     </p>
     <p  class="mt-5 text-sm text-blue-800 dark:text-white/90">
    <span class="font-bold mr-24 text-gray-800"> ግንባር:</span>  {{ matchedHistory.forehead }}
     </p>
    </div>
    <div class="">
     <p  class="mt-1 text-sm text-blue-800 dark:text-white/90">
    <span class="font-bold mr-18 text-gray-800"> ልዩ ምልክት :</span>  {{ matchedHistory.unique_appearance}}
     </p>

     <p  class="mt-5 text-sm text-blue-800 dark:text-white/90">
      <span class="font-bold mr-16 text-gray-800 "> ተጨማሪ ገለጻ :</span>  {{ matchedHistory.extra_description }}
     </p>
   </div>
   <div>
    <p  class="mt-1 text-sm text-blue-800 dark:text-white/90">
      <span class="font-bold mr-25 text-gray-800"> ዜግነት:</span>  {{ matchedHistory.citizenship }}
     </p>
   </div>
