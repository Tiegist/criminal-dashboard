      ...
      <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-1 lg:gap-7 2xl:gap-x-32">
            <div class="flex ">
              <div
                v-for="(crime, i) in history.prisioner_crimes"
                :key="i"
                class="min-w-[200px]"
              >
              ...
              <button v-if="prisoner?.id" @click="addNewStory(prisoner.id)"
...
const addNewStory = (prisoner_id) => {
  router.push({ name: 'PrisionerCourtHistory', query: { prisoner: prisoner_id } })
}
