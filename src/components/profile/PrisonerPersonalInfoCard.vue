        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div class="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
              <img :src="'https://kalkidan.net:2083/' + props.history?.photo" alt="user" />
            </div>
            <div>
            ...
            <div>
              ...
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ props.history.educational_level.name }}
              </p>
            </div>
...
const editPrisoner = (id) => {
  router.push({ name: 'prisonerForm', query: { prison_history_id: id, mode: 'edit' } });
}
</script>