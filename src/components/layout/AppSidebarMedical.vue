    ...
    <div :class="[
      ...
      <router-link to="/">
        <div class="flex">
          ...
          <img v-if="isExpanded || isHovered || isMobileOpen" class="dark:hidden" src="/criminallogo.png" alt="Logo"
            width="60" height="20" color="white" />
          ...
          <span v-if="isExpanded || isHovered || isMobileOpen" class="mt-1 ml-2 text-sm font-semibold leading-tight text-white">
            {{ t('app.shortName') }}
          </span>
        </div>
...
import { medicalMenuGroups } from "@/config/navigation";

const route = useRoute();
const { t } = useI18n();
const { isExpanded, isMobileOpen, isHovered, openSubmenu } = useSidebar();

const menuGroups = medicalMenuGroups;
